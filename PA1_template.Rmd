...
The most activity, averaged across all days, is observed for the interval `r maxInterval` (presumably while the subject is commuting to work, either on foot or by public transportation). As expected, the nighttime hours are relatively devoid of activity.
